...
def sub_print(instruction):
    ...
    if validity_check_opcode(templst[0]) == False:
        ...
        return s
    if len(templst) != 4:
        s="number of args in subtract instruction is invalid"
        return s
    j = 1
    for i in range(3):
...
def move_immediate(instruction):
    ...
    if validity_check_opcode(templst[0]) == False:
        ...
        return s
    if len(templst) != 3:
        s="number of args in move imm instruction is invalid"
        return s
...
def move_register(instruction):
    ...
    if (validity_check_opcode(lst[0]) == False):
        ...
        return s
    if len(lst) != 3:
        s="number of arguments in move registers instruction is invalid"
        return s
    for i in range(1,3):
...
def mul_print(instruction):
    ...
    if validity_check_opcode(templst[0]) == False:
        ...
        return s
    if len(templst) != 4:
        s="number of args in multiply instruction is invalid"
        return s
    j = 1
    for i in range(3):
        if validity_check_register(templst[j]) == False:
...
def divide(instruction):
    ...
    if (validity_check_opcode(lst[0]) == False):
        ...
        return s
    if len(lst) != 3:
        s="number of arguments in division instruction is invalid"
        return s
    for i in range(1,3):
        if validity_check_register(lst[i]) == False:
            s="format of registers is invalid"
...
def xor_print(instruction):
    ...
    if validity_check_opcode(templst[0]) == False:
        ...
        return s
    if len(templst) != 4:
        s="number of args in XOR instruction is invalid"
        return s
    j = 1
    for i in range(3):
        if validity_check_register(templst[j]) == False:
...
def Or(instruction):
    ...
    if (validity_check_opcode(lst[0]) == False):
        ...
        return s
    if len(lst) != 4:
        s="number of arguments in or instruction is invalid"
        return s
    for i in range(1,4):
        if validity_check_register(lst[i]) == False:
            s="format of registers is invalid"
...
def and_print(instruction):
    ...
    if (validity_check_opcode(temp_lst[0]) == False):
        ...
        return s
    if len(temp_lst) != 4:
        s="number of arguments in logical-and instruction is invalid"
        return s
    for i in range(1,4):
        if validity_check_register(temp_lst[i]) == False:
            s="format of registers is invalid"
...
def compare_print(instruction):
    ...
    if validity_check_opcode(templst[0]) == False:
        ...
        return s
    if len(templst) != 3:
        s="number of args in compare instruction is invalid"
        return s
    j = 1
    for i in range(2):
        if validity_check_register(templst[j]) == False:
